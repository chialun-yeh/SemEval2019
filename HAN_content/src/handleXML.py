...
"""
@author: chialunyeh
Extract text from XML for easier processing. 
This would not be necessary if a way to iterate XML is implemented.
The nested structure of paragraphs, quotes, urls, and text makes iterparse difficult to preserve the order.
"""
import re
import xml.sax
import lxml.sax
